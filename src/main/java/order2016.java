...
public class order2016  implements PageProcessor{
        ...
        if (page.getUrl().toString() == "https://www.toryburch.com/stores-viewal")
        {
            ...
            for (int i = 0; i < province.length; i++) {
                ...
                for (int j = 0; j < type.length; j++) {
                    ...
                    url.append("http://www.tower.com.cn/default/main/skins/menubar/cn.chinatowercom.obp.portal.getProtal.getSupplyInfo.biz.ext?ProvinceOrgCode=" + province[i] + "&prd_big_type_code=" + type[j] + "&supplycode=null&orderYear=2016&pageIndex=0&pageSize=100000");
...

        {
            ...
            synchronized (Lock)
            {
                ...
                try{
                    ...
                    String fileName="/Users/wangdong/order2016.txt";
    ...
    public static void main(String[] args) {
        ...
        Spider.create(new order2016()).addUrl(url).thread(10).run();
    }
